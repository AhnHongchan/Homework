...
CREATE TABLE orders (
    order_id INTEGER PRIMARY KEY,   -- 주문 ID (기본 키)
    order_date DATE,                -- 주문 날짜 (날짜 타입)
    price integer NULL,               -- 총 주문 금액 (실수 타입)
...
INSERT INTO orders (order_id, order_date, price, customer_id) VALUES
    (1, '2023-07-15', 50, 1),      -- 2023년 7월 15일 주문, 총 주문 금액: 50.99
    (2, '2023-07-16', 75, 2),      -- 2023년 7월 16일 주문, 총 주문 금액: 75.50
    (3, '2023-07-17', 30, 3);      -- 2023년 7월 17일 주문, 총 주문 금액: 30.25


SELECT order_id, name, order_date, price FROM orders
